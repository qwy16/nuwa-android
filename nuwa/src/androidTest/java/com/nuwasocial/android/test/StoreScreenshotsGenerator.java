package com.nuwasocial.android.test;
...
import com.nuwasocial.android.GlobalUserPreferences;
...
import com.nuwasocial.android.fragments.ComposeFragment;
import com.nuwasocial.android.fragments.ThreadFragment;
import com.nuwasocial.android.fragments.onboarding.InstanceRulesFragment;
import com.nuwasocial.android.model.Instance;
import com.nuwasocial.android.model.Status;
import com.nuwasocial.android.ui.utils.UiUtils;
...
public class StoreScreenshotsGenerator{
	...
	public void takeScreenshots() throws Exception{
		File photo=new File(NuwaApp.context.getCacheDir(), PHOTO_FILE);
		...
		NuwaApp.context.deleteDatabase(session.getID()+".db");
